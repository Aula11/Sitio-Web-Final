<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ServicioImpresion.aspx.cs" Inherits="Consulta_Pedido" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <%-- <asp:GridView ID="GridView1" runat="server" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging">
    ...
    <asp:Button ID="Logout" runat="server" Text="Cerrar Sesión"   style="position:relative; top: 0px; left: 861px;" OnClick="Logout_Click" CausesValidation="False" />
          ...
          <div class="box box-primary">
            ...
            <asp:DropDownList ID="lstTamHoja" runat="server" ForeColor="Red" AutoPostBack="True">
                ...
                <div class="form-group" style="position:relative;">
                  <label>Número de paginas a imprimir</label><br />
                    <asp:TextBox ID="txtNPag" runat="server"  placeholder="Ejemplo: 3" ForeColor="Red"></asp:TextBox><br />   
                    <asp:RequiredFieldValidator  ID="RequiredFieldValidator1" runat="server" style="position:relative;" ErrorMessage="Ingresar Nùmero de Pàginas" ControlToValidate="txtNPag" ForeColor="Red"></asp:RequiredFieldValidator><br />
                    <asp:RegularExpressionValidator  ID="RegularExpressionValidator1" runat="server"   ErrorMessage="Ingresar un Número" ControlToValidate="txtNPag" ValidationExpression="^[0-9]*$" ForeColor="Red"></asp:RegularExpressionValidator>

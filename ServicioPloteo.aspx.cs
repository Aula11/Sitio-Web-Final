...
public partial class ServicioPloteo : System.Web.UI.Page
{
...
String ESCALA = txtEscala.Text;
String NOMBRE_ARCHIVO = Path.GetFileName(FileUpload1.PostedFile.FileName);
string sql3 = "insert into PLOTEO (ID_PEDIDO,TAMAÑO_HOJA ,ESCALA,NOMBRE_ARCHIVO,PLOTEO_ARCHIVO ,TIPO_ARCHIVO, DESCRIPCION) values (@ID_PEDIDO,@TAMAÑO_HOJA ,@ESCALA,@NOMBRE_ARCHIVO, @PLOTEO_ARCHIVO ,@TIPO_ARCHIVO,@DESCRIPCION)";
...
cmd3.Parameters.Add("@ESCALA", System.Data.SqlDbType.VarChar).Value = ESCALA;
cmd3.Parameters.Add("@NOMBRE_ARCHIVO", System.Data.SqlDbType.VarChar).Value = NOMBRE_ARCHIVO;
cmd3.Parameters.Add("@PLOTEO_ARCHIVO ", System.Data.SqlDbType.VarBinary).Value = byteFile;
